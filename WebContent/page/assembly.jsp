		...
		<div>
			<div class="cl pd-20">
				<div class="cl pd-5 bg-1 bk-gray">
					...
					</span> &nbsp;&nbsp;&nbsp;&nbsp;装配人 <input type="text" id="per" /> <input
	...
	<script type="text/javascript">
		...
		function build_table(result) {
			...
			$.each(assems, function(index, item) {
				...
				var productiveTaskId = $("<td></td>").append(
						item.productiveTaskId);
				...
				var a1 = $("<a></a>").attr("title", "编辑").attr("href",
						"javascript:;").attr(
						"onclick",
						"assembly_edit('编辑装配表','${APP_PATH}/assembly_modify.jsp',"
				...
				var a2 = $("<a></a>").addClass("ml-5").attr("title", "删除")
						.attr("href", "javascript:;").attr("onclick",
								"assembly_del(" + item.id + ")").attr("style",
								"text-decoration: none").append(
