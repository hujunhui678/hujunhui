...
<article class="cl pd-20" style="margin-right:50px;">
    <form action="#" method="post" class="form form-horizontal"
          id="form-assembly-modi" style="line-height: 30px;">
    </form>

    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span
                class="c-red">*</span>装配表编号：</label>
...
<script type="text/javascript">
    ...
    $("#sub").click(function() {
        if($("#desc").val()===""){
            layer.alert('完成时间不能为空！', {icon: 5});
            return ;
        }

        $.ajax({
            url:"${APP_PATH}/assembly_edit/${param.id}",
            type:"PUT",
            data:$("#form-assembly-modi").serialize(),
            success:function (result) {
