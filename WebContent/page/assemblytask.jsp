		...
		<div>
			<div class="cl pd-20">
				<div class="cl pd-5 bg-1 bk-gray">
					...
					</span> &nbsp;&nbsp;&nbsp;&nbsp;成品类型 <input type="text" id="fin" /> <input
	...
	<script type="text/javascript">
		...
		function build_table(result) {
			...
			$.each(assems, function(index, item) {
				...
				var finishedTypeEntityType = $("<td></td>").append(
						item.finishedTypeEntity.productType);
				var leaderName = $("<td></td>").append(
						item.assemblyLeaderEntity.name);
				...
				var a1 = $("<a></a>").attr("title", "编辑").attr("href",
						"javascript:;").attr(
						"onclick",
						"asseblytask_edit('编辑装配任务','${APP_PATH}/assemblytask_modify.jsp',"
