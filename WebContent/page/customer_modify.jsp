...
<body>
	...
	<form action="${pageContext.request.contextPath }/updateCustomer" method="post" class="form form-horizontal"
		...
		<div class="row cl" style="display: none;">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${param.isPerson}"
					...
					class="input-text" value="${clients.id}" placeholder="" id="id"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder=""
					id="clientCompany" name="clientCompany">
			</div>
		</div>
		<div class="row cl">
