...
<head>
	...
	<link rel="stylesheet" type="text/css"
		  href="${pageContext.request.contextPath }/statics/static/h-ui.productionLeader/css/H-ui.productionLeader.css" />
	<link rel="stylesheet" type="text/css"
		  href="${pageContext.request.contextPath }/statics/lib/Hui-iconfont/1.0.8/iconfont.css" />
	<link rel="stylesheet" type="text/css"
		  href="${pageContext.request.contextPath }/statics/static/h-ui.productionLeader/skin/default/skin.css"
		  id="skin" />
	<link rel="stylesheet" type="text/css"
		  href="${pageContext.request.contextPath }/statics/static/h-ui.productionLeader/css/style.css" />
	<link rel="stylesheet"
		...
		<div class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray">
					<span class="l"> <a href="javascript:;" onclick="datadel()"
							...
							批量删除</a> <a class="btn btn-primary radius" href="javascript:;"
										onclick="admin_add('添加生产任务','${pageContext.request.contextPath}/page/productivetask_add.jsp','900','400')"><i
			...
			<div class="mt-10">
				<table
					...
					<thead>
					<tr>
						<th scope="col" colspan="9">人员管理</th>
					</tr>
					<tr class="text-c">
					...
					<c:forEach var="item" items="${page.lists }" varStatus="index">
						<tr class="text-c">
							...
							<td>${item.productionLeader }</td>
							<td>${item.productionNum}</td>
							<td>${item.estimatedTimeOfCompletion }</td>
							<td>${item.desc }</td>
                            ...
                            .pagination(
                                {
                                    ...
                                    callback : function(current) {
                                        $("#current1")
                                            .text(current);
                                        window.location.href = "productive?currentPage="
                                            + current+"&sel="+sel;
                                    }
                                });
                    });
...
<script type="text/javascript"
		src="${pageContext.request.contextPath }/statics/static/h-ui.productionLeader/js/H-ui.productionLeader.page.js"></script>
<!--/_footer /作为公共模版分离出去-->
